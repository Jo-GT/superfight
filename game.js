...
class Projectile {
  constructor(owner, type) { this.owner = owner; this.type = type; this.x = owner.x + owner.facing * 105; this.y = owner.y - (type === 'special' ? 120 : 65); this.direction = owner.facing; this.frame = 0; this.frameClock = 0; this.age = 0; this.hit = false; this.speed = type === 'special' ? 8.5 : type === 'attack4' ? 12 : 10; this.damage = type === 'special' ? 24 : type === 'attack4' ? 10 : type === 'attack1' ? 4 : 12; }
